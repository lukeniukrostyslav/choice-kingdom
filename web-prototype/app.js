...
const panels={
  ...
  investigation:`<h2>Investigation</h2><p>Evidence is presented as a chain of claims, sources and uncertainty. The interface never reveals a hidden outcome simply because the runtime knows it.</p><div class="evidence-chain"><div class="evidence-node"><small>01 · SOURCE</small><strong>Winter ledger</strong><span>Unsigned record brought by Mara.</span></div><div class="evidence-node"><small>02 · CROSS-CHECK</small><strong>Crown grain accounts</strong><span>Figures do not reconcile with the ledger.</span></div><div class="evidence-node is-open"><small>03 · OPEN QUESTION</small><strong>Where did the grain move?</strong><span>Unresolved until an authored route supplies further evidence.</span></div></div>`,
  ending:`<h2>The Chronicle's Ending</h2><p>An ending should read like the final page of a reign: causal, authored and specific to the path taken—not a score screen.</p><div class="ending-card"><small>ENDING RECORD · NOT YET RESOLVED</small><strong>The winter accounts remain open.</strong><span>Future consequences and ending facts must come from GameSession and authored ending contracts.</span></div><div class="panel-note"><strong>Replay</strong><span>A new reign is presented separately from the completed chronicle.</span></div>`
};
