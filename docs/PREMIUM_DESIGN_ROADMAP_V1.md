...
- P6 Choice Experience: **35%** — explicit visual state-family proof for idle, focused, selected, pressed, resolving, disabled, resolved and error/fallback behavior; runtime presentation now separates pressed from resolving while preserving the presentation/gameplay boundary; regression coverage verifies focus/press/begin do not mutate the gameplay snapshot. Complete catalog coverage, full rendered state verification, consequence handoff, final artwork, localization, Android integration and final rendered/device QA remain open.
...
Verified average across P1–P25: **6.8%**.
