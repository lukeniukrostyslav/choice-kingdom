...
| `pred.systemic_explanation_verified` | predicate | E132–E135/E232–E236 evidence candidates | E207/endgame | CONTRACT FROZEN / PRODUCERS OPEN | three evidence domains + explicit convergence decision |
| `pred.coalition_cooperation` | predicate | E148-A + distinct faction evidence candidates | E201/E207/E261+ | CONTRACT FROZEN / PRODUCERS OPEN | positive cooperation and participant identity required |
| `pred.constitutional_prepared_strong` | predicate | civic=`people_charter_endorsed`; institutional=`crown_audited`/`full_crown_audit_published`; factional=`house_assembly`; military=`military_red_line` | E197 | PARTIAL / SOURCES FROZEN | any 3 independent preparation domains; anti-double-counting still open |
| `pred.budget_reform` | predicate | E142/E154/E198 candidates | E198 | OPEN | institutional layers must be reconciled before freezing formula |
