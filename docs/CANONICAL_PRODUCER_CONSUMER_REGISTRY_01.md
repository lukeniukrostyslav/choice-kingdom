...
| `pred.guild_influence_strong` | predicate | three-domain derived predicate: representation + tribunal + commercial_market + qualified_logistics inputs | E200 | SOURCE CONTRACT CLOSED / RUNTIME OPEN | **at least 3 distinct domains**; E144 representation is one domain; `rel.ivo` alone forbidden |
| `pred.systemic_explanation_verified` | predicate | E232–E236 candidate evidence families + E270-A convergence | E207/endgame | SOURCE-CLOSED / RUNTIME OPEN | E270-A cannot manufacture missing evidence families |
