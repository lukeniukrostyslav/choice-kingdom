...
Scope: canonical state families identified across E01–E271.
...
The E211–E270 expansion has received a dedicated producer/consumer audit. A new authored bridge node, E271, now explicitly separates border-crisis declaration from prior warning infrastructure and downstream crisis consumers. E271-A is the verified declaration producer; E271-B is an explicit non-crisis/de-escalation branch. Runtime validation is still absent.
...
| `thread.border_crisis` | thread | E271-A declaration; E271-B explicit non-crisis branch | E195/E240/E251/E253+ | VERIFIED SOURCE PRODUCER / RUNTIME OPEN | E271-A establishes declaration; later resolution producer still required |
...
| `pred.border_crisis` | predicate | E271-A `border_crisis_declared` | E195/E253/E255+ | VERIFIED SOURCE PRODUCER / RUNTIME OPEN | true after E271-A until canonical resolution marker invalidates it |
...
## E211–E271 audit result

E211–E270 contain useful authored markers but still require normalization of prose triggers, explicit producer enumeration, delayed/replay metadata, and graph/reachability reconciliation. E251–E255 remain crisis consumers; E253 does not produce `pred.border_crisis`. E271 now closes the previously missing source-level declaration gap without reclassifying downstream consumers. E256–E260 are constitutional stress tests and cannot retroactively create prerequisites. E261–E265 keep coalition cooperation distinct from route count and durability. E266–E270 are endgame character/evidence nodes, not automatic prerequisite producers.
