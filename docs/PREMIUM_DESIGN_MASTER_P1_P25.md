...
**Aggregate P1–P25 estimate: 24.00% (V2 current; simple arithmetic mean with P6 now closed at 100%).**
...
Continue the premium-design track with P7 — Event / Situation Presentation. Rebuild the event surface directly from the canonical V2 visual reference: authored cinematic atmosphere, clear event hierarchy, readable situation text, explicit state feedback, responsive reflow, accessibility and no dashboard-like treatment.
