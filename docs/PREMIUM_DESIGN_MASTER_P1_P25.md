...
| P6 | Choice experience / choice cards / choice chamber | 90% | All choice states + proof + accessibility + visual regression |
...
**Aggregate P1–P25 estimate: 23.60% (V2 current; simple arithmetic mean with P6 implementation at 90% pending verified regression evidence).**
