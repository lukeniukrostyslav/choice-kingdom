...
- **Ending Precedence Boundary Validator:** added `tools/validate_ending_precedence_boundary.py`. Commit `e28ac148428db62c920978cbb868a22c792f97da`.
- **Canonical Graph CI:** wired the ending-precedence boundary validator and report. Commit `f0375fae6380fefc377eee82dbe6224af6e365e9`.
