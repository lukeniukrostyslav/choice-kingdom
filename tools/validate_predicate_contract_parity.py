...
def main()->int:
    ...
    report={"schema_version":"1.5","contract":"choice_kingdom.predicate_contract_parity","scope":"E01-E272","readiness":"BLOCKED" if errors else "SOURCE_LEVEL_CLOSED","gameplay_verified":False,"semantic_equality_proven":False,"errors":errors,"checked":checked,"rules":["machine graph and authoritative markdown must agree on frozen composite status","source-level closure does not prove gameplay reachability or runtime invalidation","OPEN/OPEN-BLOCKED predicates are never promoted by this gate","pred.food_stable is source-closed only because E192-B is an in-scope authored producer with explicit E192-A clear semantics"]}
